        ...
        <section class="choice-list__wrap">
            ...
            <ul class="choice-list__menu departments" role="menu">
                ...
                foreach ( $departments as $department_name => $department_coll ) {
                    ?>
                    <li class="choice-list__item" role="menuitem" data-filter-tax="<?php echo $department_coll['taxonomy']; ?>"
                        data-filter-termId="<?php echo $department_coll['term_id']; ?>">
                        ...
                        <label for="department-checkbox-0"
                            ...
                            <span class="choice-list__label-name"><?php echo $department_name; ?></span>
                        </label>
                        <span class="choice-list__vac-count"><?php echo $department_coll['job_count']; ?></span>
                    </li>
                    <?php
                }
                ?>
